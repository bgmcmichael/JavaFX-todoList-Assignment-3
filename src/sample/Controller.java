...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        System.out.println("Please enter your email to log in or create a new account");
        String email = scan.nextLine();
        try {
            currentUser = ToDoDatabase.selectAUser(conn, email);
            sqlList = ToDoDatabase.selectToDos(conn, email);
            if (currentUser == null){
                System.out.println("What is your first name?");
                String firstName = scan.nextLine();
                System.out.println("What is your last name?");
                String lastName = scan.nextLine();
                toDoDatabase.insertUser(conn, email, firstName, lastName);
                currentUser = ToDoDatabase.selectAUser(conn, email);
            }
...
//        }
    ...
    public void addItem() {
        ...
        todoItems.add(item);
        try {
            toDoDatabase.insertToDo(conn, ToDoDatabase.userID, item.text);
        } catch (SQLException e) {
            e.printStackTrace();
        }
        todoText.setText("");
    ...
    public void removeItem() {
        ...
        try {
            toDoDatabase.deleteToDo(conn, ToDoDatabase.userID, todoItem.text);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void toggleItem() {
        ...
        try {
            ...
            while (results.next()) {
                ...
                toDoDatabase.toggleToDo(conn, ToDoDatabase.userID, results.getInt("id"));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
